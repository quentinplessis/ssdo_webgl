...
THREE.MTLLoader.MaterialCreator.prototype = {
	...
	createMaterial_: function ( materialName ) {
		...
		for ( var prop in mat ) {
			...
			switch ( prop.toLowerCase() ) {
				...
				case 'kd':
					...
					params2['diffuse'] = new THREE.Vector4(value[0], value[1], value[2], 1.0);
					break;
				...
				case 'ka':
					...
					params2['ambient'] = new THREE.Vector4(value[0], value[1], value[2], 1.0);
					break;
				...
				case 'ks':
					...
					params2['specular'] = new THREE.Vector4(value[0], value[1], value[2], 1.0);
					break;
				...
				case 'map_kd':
					...
					params2['diffuseMap'] = THREE.MTLLoader.loadTexture( this.baseUrl + value );
					break;
				
				case 'map_ka':
					params2['ambientMap'] = 'aM';
					break;
				case 'map_ks':
					params2['specularMap'] = 'sM';
					break;
				case 'map_bump':
					params2['bumpMap'] = 'bM';
					break;
		...
		this.materials[materialName].params = params2;
		return this.materials[ materialName ];
